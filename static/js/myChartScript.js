...
var chart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: 'Crime Reports',
            backgroundColor: 'rgba(244,98,58, 0.5)', // Background color of the line area
            borderColor: 'rgba(244,98,58, 1)', // Border color of the line
            borderWidth: 1.6, // Thickness of the line
            pointBackgroundColor: '#fff', // Color of the data points
            pointBorderColor: 'rgba(244,98,58, 1)', // Border color of the data points
            pointHoverBackgroundColor: 'rgba(244,98,58, 1)', // Background color when hovered
